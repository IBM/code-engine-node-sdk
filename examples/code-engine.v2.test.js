...
describe('CodeEngineV2', () => {
  ...
  test('createPersistentDataStore request example', async () => {
    ...
    originalLog('createPersistentDataStore() result:');
    ...
    let res;
    try {
      res = await codeEngineService.createPersistentDataStore(params);
      console.log(JSON.stringify(res.result, null, 2));
    } catch (err) {
      console.warn(err);
    }
  ...
  test('getPersistentDataStore request example', async () => {
    consoleLogMock.mockImplementation((output) => {
      originalLog(output);
    });
    consoleWarnMock.mockImplementation((output) => {
    ...
    originalLog('getPersistentDataStore() result:');
    ...
    let res;
    try {
      res = await codeEngineService.getPersistentDataStore(params);
      console.log(JSON.stringify(res.result, null, 2));
    } catch (err) {
      console.warn(err);
    }
  ...
  test('deletePersistentDataStore request example', async () => {
    consoleLogMock.mockImplementation((output) => {
      originalLog(output);
    });
    consoleWarnMock.mockImplementation((output) => {
    ...
    try {
      await codeEngineService.deletePersistentDataStore(params);
    } catch (err) {
      console.warn(err);
    }
